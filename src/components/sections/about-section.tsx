...
export function AboutSection() {
  ...
  return (
    <section id="about" className="py-20 bg-slate-950 relative tech-pattern overflow-hidden">
          ...
          >
            <div className="space-y-6">
              <p className="text-lg text-slate-300 leading-relaxed">
                Sou um estudante apaixonado por tecnologia, sempre em busca de novos conhecimentos 
                e desafios. Durante minha jornada acadêmica em Ciência da Computação, tenho me 
                dedicado a desenvolver projetos que demonstram minhas habilidades técnicas e 
                criatividade.
              </p>
              
              <p className="text-lg text-slate-300 leading-relaxed">
                Minha paixão pela programação começou cedo, e desde então tenho explorado diversas 
                áreas do desenvolvimento de software, desde desenvolvimento web até aplicações mobile. 
                Acredito que a tecnologia pode transformar o mundo e estou empolgado para fazer parte 
                dessa transformação.
              </p>
              
              <p className="text-lg text-slate-300 leading-relaxed">
                Quando não estou codificando, gosto de estudar novas tecnologias, participar de 
                comunidades de desenvolvedores e trabalhar em projetos pessoais que me desafiam a 
